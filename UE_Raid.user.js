...
//Quest presets
var aq4 = {"type": "accessory"};
var dailySP = {"type":"daily", "use_he": false, "party": "G", "ap": 50};
var dailyGemQuest = {"type": "gem_daily", "use_he": false, "element": "fire", "summon": "Sleipnir"};
var gemQuest = {"type": "gem", "element": "dark", "doFirst": true};
var eventQuest = {"type": "event", "element": "water", "ap": 30, "use_he": false};
var standardEventRaid = {"type": "event_raid", "ap": 15, "element": "light", "use_he": false};
var expertEventRaid = {"type": "event_raid", "ap": 25, "element": "light", "use_he": false, "priority": "participants","max_participants": 2, "min_time": 5, "min_hp": 80, "min_bp": 1};
var ragnarokEventRaid = {"type": "event_raid", "ap": 35, "element": "light", "use_he": false, "priority": "participants", "max_participants": 2, "min_time": 40, "min_hp": 80, "min_bp": 0};
var lilimRaid = {"type": "lilim", "use_he": false, "min_bp": 2};
var fireRag = {"type": "disaster", "raid_element": "fire", "element": "water", "use_he": false, "min_bp": 4, "min_hp": 80, "priority": "participants", "ap": 50};
var lightRag = {"type": "disaster", "raid_element": "light", "element": "dark", "use_he": false, "min_bp": 4, "min_hp": 80, "priority": "participants", "ap": 50};
var thunderRag = {"type": "disaster", "raid_element": "thunder", "element": "dark", "use_he": false, "min_bp": 4, "min_hp": 80, "priority": "participants", "ap": 50};
var darkRag = {"type": "disaster", "raid_element": "dark", "element": "light", "use_he": false, "min_bp": 4, "min_hp": 80, "priority": "participants", "ap": 50};
var waterRag = {"type": "disaster", "raid_element": "water", "element": "light", "use_he": false, "min_bp": 4, "min_hp": 80, "priority": "participants", "ap": 50};
var storyEvent = {"type": "story_event", "ap": 10, "element": "dark", "use_he": false};

//Add all quests you want to check in here: storyEvent lightRag eventQuest darkRag darkRag, eventQuest,
var questPriorityList = [gemQuest, dailySP]

//Raid presets
var disasterRag = {"type": "disaster", "ap": 50, "priority": "participants", "min_hp": 50, "min_bp": 5};
var unionExpert = {"type": "ue_expert", "element": "wind", "max_participants": 0, "not_last": false, "min_hp": 70, "min_bp": 1};
...
//Your settings
var parties = {"fire": "E","water": "C","wind": "D","thunder": "F","dark": "A","light": "B"};
...
var halfElixirLimit =251;       //If your half elixir count reaches this limit, the script will stop using them.
var seedLimit = 725;            //If your seed count reaches this limit, the script will stop using them.
...
function waitBeforeStart() {
    info.questPriorityList = questPriorityList.slice();
    info.raidPriorityList = raidPriorityList.slice();
    quest = undefined;
    if (location.host === "cf.r.kamihimeproject.dmmgames.com"){
        href = "https://cf.r.kamihimeproject.dmmgames.com/front/cocos2d-proj/components-pc/mypage_quest_party_guild_enh_evo_gacha_present_shop_epi_acce_detail/app.html";
    } else {
        href = "https://cf.g.kamihimeproject.dmmgames.com/front/cocos2d-proj/components-pc/mypage_quest_party_guild_enh_evo_gacha_present_shop_epi_acce_detail/app.html";
    }
    ...
    if (has(kh,"createInstance")) {
        if (location.hash.startsWith("#!quest/q_003_1")){
            ...
            setTimeout(refreshPage,3000*timeoutMulti);
        } else {
            getPlayerInfo();
        }
    } else {
